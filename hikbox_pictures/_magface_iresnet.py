...
def _iresnet(blocks: list[int], **kwargs: object) -> IResNet:
    return IResNet(IBasicBlock, blocks, **kwargs)


def iresnet18(**kwargs: object) -> IResNet:
    return _iresnet([2, 2, 2, 2], **kwargs)


def iresnet34(**kwargs: object) -> IResNet:
    return _iresnet([3, 4, 6, 3], **kwargs)


def iresnet50(**kwargs: object) -> IResNet:
    return _iresnet([3, 4, 14, 3], **kwargs)


def iresnet100(**kwargs: object) -> IResNet:
    return _iresnet([3, 13, 30, 3], **kwargs)
