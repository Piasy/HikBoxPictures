...
def test_main_exports_only_hits_and_prints_summary(monkeypatch, tmp_path, capsys) -> None:
    ...
    monkeypatch.setattr("hikbox_pictures.cli.InsightFaceEngine.create", fake_create_engine)
...
def test_main_exits_nonzero_when_reference_dir_loading_fails(monkeypatch, tmp_path, capsys) -> None:
    ...
    monkeypatch.setattr("hikbox_pictures.cli.InsightFaceEngine.create", lambda: object())
...
def test_main_exits_nonzero_when_engine_init_fails(monkeypatch, tmp_path, capsys) -> None:
    ...
    monkeypatch.setattr("hikbox_pictures.cli.InsightFaceEngine.create", raise_init_error)
...
def test_main_counts_decode_errors_and_missing_live_photo_videos(monkeypatch, tmp_path, capsys) -> None:
    ...
    fake_engine = object()
    monkeypatch.setattr("hikbox_pictures.cli.InsightFaceEngine.create", lambda: fake_engine)
    monkeypatch.setattr(
